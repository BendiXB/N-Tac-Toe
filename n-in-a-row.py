...
# usefull function for counting in array
...
# usefull function for generating array of strings
...
# setup
player1 = player(name='Alice', symbol='X', color=formatting.purple) # object player one
player2 = player(name='Bob', symbol='O', color=formatting.green)    # object player two
