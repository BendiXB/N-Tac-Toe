...
def count(array,variable):  # counts occurrence of variable in array
    number = 0
    for row in range(len(array)):               # iterating thru rows
        for column in range(len(array[0])):     # iterating thru column in this row
...
class game:     # class containing all game assets and mainloop
    ...
    def printmap(self):     # function to print the map
        ...
        for row in self.map:    # iterating thru rows of map except last
